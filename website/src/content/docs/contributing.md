---
title: Contributing
description: How to contribute to Fleet — adapters, protocol feedback, and testing.
---
...
**Adapters** — wrappers for Gemini CLI, OpenCode, Cursor CLI, Amp, and others. See [adapters](adapters). This is the highest-impact contribution.

**Protocol feedback** — read [protocol](protocol) and open an issue if anything is unclear, broken, or missing. The protocol is v1.0 and we want it stable before v1.0 CLI release.
